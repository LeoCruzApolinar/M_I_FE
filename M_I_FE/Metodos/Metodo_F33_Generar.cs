...
{
    public class Metodo_F33_Generar
    {
        public class ObtenerValorECF_33()
        {
            ...
            public static ECF_33.ECFEncabezadoIdDocFormaDePago[] ObtenerTablaFormasPago(Dictionary<string, string> datos)
            {
                List<ECF_33.ECFEncabezadoIdDocFormaDePago> listaFormasPago = new List<ECF_33.ECFEncabezadoIdDocFormaDePago>();
                ...
                while (true)
                {
                    ...
                    if (datos.ContainsKey(formaPagoKey) && datos.ContainsKey(montoPagoKey))
                    {
                        ...
                        {
                            ECF_33.ECFEncabezadoIdDocFormaDePago formaPago = new ECF_33.ECFEncabezadoIdDocFormaDePago
                            {
                                FormaPago = ObtenerTipoGeneral<ECF_33.FormaPagoType>(datos[formaPagoKey]),
            ...
            public static ECF_33.ECFEncabezadoTotalesImpuestoAdicional[] ObtenerImpuestosAdicionales(Dictionary<string, string> Data)
            {
                List<ECF_33.ECFEncabezadoTotalesImpuestoAdicional> ImpuestosAdicionales = new List<ECF_33.ECFEncabezadoTotalesImpuestoAdicional>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"TipoImpuesto[{indice}]"))
                    {
                        if (Data[$"TipoImpuesto[{indice}]"] != null)
                        {
                            ...
                            ECF_33.ECFEncabezadoTotalesImpuestoAdicional eCFEncabezadoTotalesImpuestoAdicional = new ECF_33.ECFEncabezadoTotalesImpuestoAdicional()
                            {
                                TipoImpuesto = ObtenerTipoGeneral<ECF_33.CodificacionTipoImpuestosType>(Data[$"TipoImpuesto[{indice}]"]),
            ...
            public static ECF_33.ECFEncabezadoOtraMonedaImpuestoAdicionalOtraMoneda[] ObtenerImpuestosAdicionalesOtraMoneda(Dictionary<string, string> Data)
            {
                List<ECF_33.ECFEncabezadoOtraMonedaImpuestoAdicionalOtraMoneda> ImpuestosAdicionalesOtraMoneda = new List<ECF_33.ECFEncabezadoOtraMonedaImpuestoAdicionalOtraMoneda>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"TipoImpuestoOtraMoneda[{indice}]"))
                    {
                        if (Data[$"TipoImpuestoOtraMoneda[{indice}]"] != null)
                        {
                            ...
                            ECF_33.ECFEncabezadoOtraMonedaImpuestoAdicionalOtraMoneda eCFEncabezadoTotalesImpuestoAdicionalOtraMoneda = new ECF_33.ECFEncabezadoOtraMonedaImpuestoAdicionalOtraMoneda()
                            {
                                TipoImpuestoOtraMoneda = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.CodificacionTipoImpuestosType>(Data[$"TipoImpuestoOtraMoneda[{indice}]"]),
            ...
            public static ECF_33.ECFItem[] ObtenerDetalleItem(Dictionary<string, string> Data)
            {
                List<ECF_33.ECFItem> eCFItems = new List<ECF_33.ECFItem>();
                int indice = 1;
                ...
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"NumeroLinea[{indice}]"))
                    {
                        if (Data[$"NumeroLinea[{indice}]"] != null)
                        {
                            ...
                            ECF_33.ECFItem eCFItem = new ECF_33.ECFItem()
                            {
                                NumeroLinea = Data[$"NumeroLinea[{indice}]"],
                                TablaCodigosItem = ObtenerCodigosItems(Data, indice),
                                IndicadorFacturacion = ObtenerTipoGeneral<ECF_33.IndicadorFacturacionType>(Data[$"IndicadorFacturacion[{indice}]"]),
                                Retencion = new ECF_33.ECFItemRetencion()
                                {
                                    IndicadorAgenteRetencionoPercepcion = ObtenerTipoGeneral<ECF_33.IndicadorAgenteRetencionoPercepcionType>(Data[$"IndicadorAgenteRetencionoPercepcion[{indice}]"]),
                                ...
                                IndicadorBienoServicio = ObtenerTipoGeneral<ECF_33.IndicadorBienoServicioType>(Data[$"IndicadorBienoServicio[{indice}]"]),
                                DescripcionItem = Data[$"DescripcionItem[{indice}]"],
                                CantidadItem = Metodos_General.TryParseDecimal(Data, $"CantidadItem[{indice}]"),
                                UnidadMedida = ObtenerTipoGeneral<ECF_33.UnidadMedidaType>(Data[$"UnidadMedida[{indice}]"]),
                                ...
                                UnidadReferencia = ObtenerTipoGeneral<ECF_33.UnidadMedidaType>(Data[$"UnidadReferencia[{indice}]"]),
                                ...
                                Mineria = new ECF_33.ECFItemMineria()
                                {
                                    ...
                                    TipoAfiliacion = ObtenerTipoGeneral<ECF_33.TipoAfiliacionType>(Data[$"TipoAfiliacion[{indice}]"]),
                                    TipoAfiliacionSpecified = Metodos_General.EsNumero(Data[$"TipoAfiliacion[{indice}]"]),
                                    Liquidacion = ObtenerTipoGeneral<ECF_33.LiquidacionType>(Data[$"Liquidacion[{indice}]"]),
                                ...
                                OtraMonedaDetalle = new ECF_33.ECFItemOtraMonedaDetalle()
                                {
            ...
            public static ECF_33.ECFItemCodigosItem[] ObtenerCodigosItems(Dictionary<string, string> Data, int ind)
            {
                List<ECF_33.ECFItemCodigosItem> eCFItemCodigosItems = new List<ECF_33.ECFItemCodigosItem>();
                ...
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"TipoCodigo[{ind}][{indice}]"))
                    {
                        if (Data[$"TipoCodigo[{ind}][{indice}]"] != null)
                        {
                            ...
                            ECF_33.ECFItemCodigosItem eCFItemCodigosItem = new ECF_33.ECFItemCodigosItem()
                            {
            ...
            public static ECF_33.ECFItemSubcantidadItem[] ObtenerECFItemSubcantidadItemTabla(Dictionary<string, string> Data)
            {
                List<ECF_33.ECFItemSubcantidadItem> eCFItemSubcantidadItems = new List<ECF_33.ECFItemSubcantidadItem>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"Subcantidad[{indice}]"))
                    {
                        if (Data[$"Subcantidad[{indice}]"] != null)
                        {
                            ...
                            ECF_33.ECFItemSubcantidadItem data = new ECF_33.ECFItemSubcantidadItem()
                            {
                                ...
                                CodigoSubcantidad = ObtenerTipoGeneral<ECF_33.UnidadMedidaType>(Data[$"CodigoSubcantidad[{indice}]"]),
            ...
            public static ECF_33.ECFItemSubDescuento[] ObtenerTablaECFItemSubDescuento(Dictionary<string, string> Data)
            {
                List<ECF_33.ECFItemSubDescuento> ListaECFItemSubDescuento = new List<ECF_33.ECFItemSubDescuento>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"TipoSubDescuento[{indice}]"))
                    {
                        if (Data[$"TipoSubDescuento[{indice}]"] != null)
                        {
                            ...
                            ECF_33.ECFItemSubDescuento data = new ECF_33.ECFItemSubDescuento()
                            {
                                TipoSubDescuento = ObtenerTipoGeneral<ECF_33.ECFItemSubDescuento>(Data[$"TipoSubDescuento[{indice}]"]),
            ...
            public static ECF_33.ECFItemSubRecargo[] ObtenerTablaECFItemSubRecargo(Dictionary<string, string> Data)
            {
                List<ECF_33.ECFItemSubRecargo> ListaECFItemSubRecargo = new List<ECF_33.ECFItemSubRecargo>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"TipoSubRecargo[{indice}]"))
                    {
                        if (Data[$"TipoSubRecargo[{indice}]"] != null)
                        {
                            ...
                            ECF_33.ECFItemSubRecargo data = new ECF_33.ECFItemSubRecargo()
                            {
                                TipoSubRecargo = ObtenerTipoGeneral<ECF_33.ECFItemSubRecargo>($"TipoSubRecargo[{indice}]"),
            ...
            public static ECF_33.ECFItemImpuestoAdicional[] ObtenerTablaImpuestoAdicional(Dictionary<string, string> Data)
            {
                List<ECF_33.ECFItemImpuestoAdicional> ListaImpuestoAdicional = new List<ECF_33.ECFItemImpuestoAdicional>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"TipoSubRecargo[{indice}]"))
                    {
                        if (Data[$"TipoSubRecargo[{indice}]"] != null)
                        {
                            ...
                            ECF_33.ECFItemImpuestoAdicional data = new ECF_33.ECFItemImpuestoAdicional()
                            {
                                TipoImpuesto = ObtenerTipoGeneral<ECF_33.ECFItemImpuestoAdicional>($"TipoImpuesto[{indice}]"),
                            };
                            // Agregar el objeto a la lista
            ...
            public static ECF_33.ECFSubtotal[] ObtenerSubtotalesl(Dictionary<string, string> Data)
            {
                List<ECF_33.ECFSubtotal> ListaSubtotales = new List<ECF_33.ECFSubtotal>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"NumeroSubTotal[{indice}]"))
                    {
                        if (Data[$"NumeroSubTotal[{indice}]"] != null)
                        {
                            ...
                            ECF_33.ECFSubtotal data = new ECF_33.ECFSubtotal()
                            {
            ...
            public static ECF_33.ECFDescuentoORecargo[] ObtenerDescuentosORecargos(Dictionary<string, string> Data)
            {
                List<ECF_33.ECFDescuentoORecargo> ListaDescuentosORecargos = new List<ECF_33.ECFDescuentoORecargo>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"NumeroSubTotal[{indice}]"))
                    {
                        if (Data[$"NumeroSubTotal[{indice}]"] != null)
                        {
                            ...
                            ECF_33.ECFDescuentoORecargo data = new ECF_33.ECFDescuentoORecargo()
                            {
                                NumeroLinea = Data[$"NumeroLinea[{indice}]"],
                                TipoAjuste = ObtenerTipoGeneral<ECF_33.TipoAjusteType>($"TipoAjuste[{indice}]"),
                                IndicadorNorma1007 = ObtenerTipoGeneral<ECF_33.IndicadorNorma1007Type>($"IndicadorNorma1007[{indice}]"),
                                ...
                                TipoValor = ObtenerTipoGeneral<ECF_33.TipoDescuentoRecargoType>($"TipoValor[{indice}]"),
                                ...
                                IndicadorFacturacionDescuentooRecargo = ObtenerTipoGeneral<ECF_33.IndicadorFacturacionDRType>($"IndicadorFacturacionDescuentooRecargo[{indice}]"),
            ...
            public static ECF_33.ECFPagina[] ObtenerECFPagina(Dictionary<string, string> Data)
            {
                List<ECF_33.ECFPagina> ListaECFPagina = new List<ECF_33.ECFPagina>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"NumeroSubTotal[{indice}]"))
                    {
                        if (Data[$"NumeroSubTotal[{indice}]"] != null)
                        {
                            ...
                            ECF_33.ECFPagina data = new ECF_33.ECFPagina()
                            {
                                ...
                                SubtotalImpuestoAdicional = new ECF_33.ECFPaginaSubtotalImpuestoAdicional()
                                {
        ...
        public static void Generar_XML_ECF33(Dictionary<string, string> Data)
        {
            ECF_33.ECF eCF_33 = new ECF_33.ECF();
            eCF_33.Encabezado = new ECF_33.ECFEncabezado()
            {
                Version = Metodos_General.TryParseDecimal(Data, "Version"),
                IdDoc = new ECF_33.ECFEncabezadoIdDoc()
                {
                    TipoeCF = ECF_33.TipoeCFType.Item33,
                    eNCF = Data["ENCF"],
                    ...
                    IndicadorEnvioDiferido = ECF_33.IndicadorEnvioDiferidoType.Item1,
                    IndicadorMontoGravadoSpecified = (Data["IndicadorMontoGravado"] == "1" || Data["IndicadorMontoGravado"] == "0"),
                    IndicadorMontoGravado = (Data["IndicadorMontoGravado"] == "1") ? ECF_33.IndicadorMontoGravadoType.Item1 : ECF_33.IndicadorMontoGravadoType.Item0,
                    TipoIngresos = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.TipoIngresosValidationType>(Data["TipoIngresos"]),
                    TipoPago = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.TipoPagoType>(Data["TipoPago"]),
                    FechaLimitePago = Data["FechaLimitePago"],
                    TerminoPago = Data["TerminoPago"],
                    TablaFormasPago = ObtenerValorECF_33.ObtenerTablaFormasPago(Data),
                    TipoCuentaPago = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.TipoCuentaPagoType>(Data["TipoCuentaPago"]),
                ...
                Emisor = new ECF_33.ECFEncabezadoEmisor()
                {
                    ...
                    Municipio = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.ProvinciaMunicipioType>(Data["Municipio"]),
                    ProvinciaSpecified = Data.ContainsKey("Provincia") && Data["Provincia"] != null,
                    Provincia = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.ProvinciaMunicipioType>(Data["Provincia"]),
                    TablaTelefonoEmisor = ObtenerValorECF_33.ObtenerTablaTelefonoEmisor(Data),
                ...
                Comprador = new ECF_33.ECFEncabezadoComprador()
                {
                    ...
                    MunicipioComprador = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.ProvinciaMunicipioType>(Data["MunicipioComprador"]),
                    ProvinciaCompradorSpecified = Data.ContainsKey("ProvinciaComprador") && Data["ProvinciaComprador"] != null,
                    ProvinciaComprador = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.ProvinciaMunicipioType>(Data["ProvinciaComprador"]),
                ...
                InformacionesAdicionales = new ECF_33.ECFEncabezadoInformacionesAdicionales
                {
                    ...
                    UnidadPesoBruto = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.UnidadMedidaType>(Data["UnidadPesoBruto"]),
                    UnidadPesoBrutoSpecified = Metodos_General.EsNumero(Data["UnidadPesoBruto"]),
                    UnidadPesoNeto = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.UnidadMedidaType>(Data["UnidadPesoNeto"]),
                    ...
                    UnidadBulto = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.UnidadMedidaType>(Data["UnidadBulto"]),
                    ...
                    UnidadVolumen = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.UnidadMedidaType>(Data["UnidadVolumen"]),
                    UnidadVolumenSpecified = Metodos_General.EsNumero(Data["UnidadVolumen"]),
                },
                Transporte = new ECF_33.ECFEncabezadoTransporte()
                {
                ...
                Totales = new ECF_33.ECFEncabezadoTotales()
                {
                    ...
                    ImpuestosAdicionales = ObtenerValorECF_33.ObtenerImpuestosAdicionales(Data),
                ...
                OtraMoneda = new ECF_33.ECFEncabezadoOtraMoneda()
                {
                    TipoMoneda = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.TipoMonedaType>(Data["TipoMoneda"]),
                    ...
                    ImpuestosAdicionalesOtraMoneda = ObtenerValorECF_33.ObtenerImpuestosAdicionalesOtraMoneda(Data),
            ...
            eCF_33.DetallesItems = ObtenerValorECF_33.ObtenerDetalleItem(Data);
            eCF_33.Subtotales = ObtenerValorECF_33.ObtenerSubtotalesl(Data);
            eCF_33.DescuentosORecargos = ObtenerValorECF_33.ObtenerDescuentosORecargos(Data);
            eCF_33.Paginacion = ObtenerValorECF_33.ObtenerECFPagina(Data);
            eCF_33.InformacionReferencia = new ECF_33.ECFInformacionReferencia
            {
                NCFModificado = Data["NCFModificado"],
                RNCOtroContribuyente = Data["RNCOtroContribuyente"],
                FechaNCFModificado = Data["FechaNCFModificado"],
                CodigoModificacion = ObtenerValorECF_33.ObtenerTipoGeneral<ECF_33.CodigoModificacionType>(Data["CodigoModificacion"]),
                RazonModificacion = Data["RazonModificacion"],
            };

            XmlSerializer serializer = new XmlSerializer(typeof(ECF_33.ECF));
            using (StringWriter writer = new StringWriter())
            {
                serializer.Serialize(writer, eCF_33);
                string xmlOutput = writer.ToString();

                string a = Metodos_General.XmlCorrector.CorrectXml(xmlOutput, "E:\\Proyectos\\M_I_FE\\M_I_FE\\XSD\\e-CF 33 v.1.0.xsd");

                Console.WriteLine(a);

                Metodos_General.SaveContentToFile(a, "33");
