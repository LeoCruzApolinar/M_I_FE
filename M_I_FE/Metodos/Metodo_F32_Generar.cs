...
{
    public class Metodo_F32_Generar
    {
        public class ObtenerValorECF_32()
        {
            ...
            public static ECF_32.ECFEncabezadoIdDocFormaDePago[] ObtenerTablaFormasPago(Dictionary<string, string> datos)
            {
                List<ECF_32.ECFEncabezadoIdDocFormaDePago> listaFormasPago = new List<ECF_32.ECFEncabezadoIdDocFormaDePago>();
                ...
                while (true)
                {
                    ...
                    if (datos.ContainsKey(formaPagoKey) && datos.ContainsKey(montoPagoKey))
                    {
                        ...
                        {
                            ECF_32.ECFEncabezadoIdDocFormaDePago formaPago = new ECF_32.ECFEncabezadoIdDocFormaDePago
                            {
                                FormaPago = ObtenerTipoGeneral<ECF_32.FormaPagoType>(datos[formaPagoKey]),
            ...
            public static ECF_32.ECFEncabezadoTotalesImpuestoAdicional[] ObtenerImpuestosAdicionales(Dictionary<string, string> Data)
            {
                List<ECF_32.ECFEncabezadoTotalesImpuestoAdicional> ImpuestosAdicionales = new List<ECF_32.ECFEncabezadoTotalesImpuestoAdicional>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"TipoImpuesto[{indice}]"))
                    {
                        if (Data[$"TipoImpuesto[{indice}]"] != null)
                        {
                            ...
                            ECF_32.ECFEncabezadoTotalesImpuestoAdicional eCFEncabezadoTotalesImpuestoAdicional = new ECF_32.ECFEncabezadoTotalesImpuestoAdicional()
                            {
                                TipoImpuesto = ObtenerTipoGeneral<ECF_32.CodificacionTipoImpuestosType>(Data[$"TipoImpuesto[{indice}]"]),
            ...
            public static ECF_32.ECFEncabezadoOtraMonedaImpuestoAdicionalOtraMoneda[] ObtenerImpuestosAdicionalesOtraMoneda(Dictionary<string, string> Data)
            {
                List<ECF_32.ECFEncabezadoOtraMonedaImpuestoAdicionalOtraMoneda> ImpuestosAdicionalesOtraMoneda = new List<ECF_32.ECFEncabezadoOtraMonedaImpuestoAdicionalOtraMoneda>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"TipoImpuestoOtraMoneda[{indice}]"))
                    {
                        if (Data[$"TipoImpuestoOtraMoneda[{indice}]"] != null)
                        {
                            ...
                            ECF_32.ECFEncabezadoOtraMonedaImpuestoAdicionalOtraMoneda eCFEncabezadoTotalesImpuestoAdicionalOtraMoneda = new ECF_32.ECFEncabezadoOtraMonedaImpuestoAdicionalOtraMoneda()
                            {
                                TipoImpuestoOtraMoneda = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.CodificacionTipoImpuestosType>(Data[$"TipoImpuestoOtraMoneda[{indice}]"]),
            ...
            public static ECF_32.ECFItem[] ObtenerDetalleItem(Dictionary<string, string> Data)
            {
                List<ECF_32.ECFItem> eCFItems = new List<ECF_32.ECFItem>();
                int indice = 1;
                ...
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"NumeroLinea[{indice}]"))
                    {
                        if (Data[$"NumeroLinea[{indice}]"] != null)
                        {
                            ...
                            ECF_32.ECFItem eCFItem = new ECF_32.ECFItem()
                            {
                                NumeroLinea = Data[$"NumeroLinea[{indice}]"],
                                TablaCodigosItem = ObtenerCodigosItems(Data, indice),
                                IndicadorFacturacion = ObtenerTipoGeneral<ECF_32.IndicadorFacturacionType>(Data[$"IndicadorFacturacion[{indice}]"]),
                                NombreItem = Data[$"NombreItem[{indice}]"],
                                IndicadorBienoServicio = ObtenerTipoGeneral<ECF_32.IndicadorBienoServicioType>(Data[$"IndicadorBienoServicio[{indice}]"]),
                                DescripcionItem = Data[$"DescripcionItem[{indice}]"],
                                CantidadItem = Metodos_General.TryParseDecimal(Data, $"CantidadItem[{indice}]"),
                                UnidadMedida = ObtenerTipoGeneral<ECF_32.UnidadMedidaType>(Data[$"UnidadMedida[{indice}]"]),
                                ...
                                UnidadReferencia = ObtenerTipoGeneral<ECF_32.UnidadMedidaType>(Data[$"UnidadReferencia[{indice}]"]),
                                ...
                                Mineria = new ECF_32.ECFItemMineria()
                                {
                                    ...
                                    TipoAfiliacion = ObtenerTipoGeneral<ECF_32.TipoAfiliacionType>(Data[$"TipoAfiliacion[{indice}]"]),
                                    TipoAfiliacionSpecified = Metodos_General.EsNumero(Data[$"TipoAfiliacion[{indice}]"]),
                                    Liquidacion = ObtenerTipoGeneral<ECF_32.LiquidacionType>(Data[$"Liquidacion[{indice}]"]),
                                ...
                                OtraMonedaDetalle = new ECF_32.ECFItemOtraMonedaDetalle()
                                {
            ...
            public static ECF_32.ECFItemCodigosItem[] ObtenerCodigosItems(Dictionary<string, string> Data, int ind)
            {
                List<ECF_32.ECFItemCodigosItem> eCFItemCodigosItems = new List<ECF_32.ECFItemCodigosItem>();
                ...
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"TipoCodigo[{ind}][{indice}]"))
                    {
                        if (Data[$"TipoCodigo[{ind}][{indice}]"] != null)
                        {
                            ...
                            ECF_32.ECFItemCodigosItem eCFItemCodigosItem = new ECF_32.ECFItemCodigosItem()
                            {
            ...
            public static ECF_32.ECFItemSubcantidadItem[] ObtenerECFItemSubcantidadItemTabla(Dictionary<string, string> Data, int ind)
            {
                List<ECF_32.ECFItemSubcantidadItem> eCFItemSubcantidadItems = new List<ECF_32.ECFItemSubcantidadItem>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"Subcantidad[{ind}][{indice}]"))
                    {
                        if (Data[$"Subcantidad[{ind}][{indice}]"] != null)
                        {
                            ...
                            ECF_32.ECFItemSubcantidadItem data = new ECF_32.ECFItemSubcantidadItem()
                            {
                                ...
                                CodigoSubcantidad = ObtenerTipoGeneral<ECF_32.UnidadMedidaType>(Data[$"CodigoSubcantidad[{ind}][{indice}]"]),
            ...
            public static ECF_32.ECFItemSubDescuento[] ObtenerTablaECFItemSubDescuento(Dictionary<string, string> Data, int ind)
            {
                List<ECF_32.ECFItemSubDescuento> ListaECFItemSubDescuento = new List<ECF_32.ECFItemSubDescuento>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"TipoSubDescuento[{ind}][{indice}]"))
                    {
                        if (Data[$"TipoSubDescuento[{ind}][{indice}]"] != null)
                        {
                            ...
                            ECF_32.ECFItemSubDescuento data = new ECF_32.ECFItemSubDescuento()
                            {
                                TipoSubDescuento = ObtenerTipoGeneral<ECF_32.TipoDescuentoRecargoType>(Data[$"TipoSubDescuento[{ind}][{indice}]"]),
            ...
            public static ECF_32.ECFItemSubRecargo[] ObtenerTablaECFItemSubRecargo(Dictionary<string, string> Data, int ind)
            {
                List<ECF_32.ECFItemSubRecargo> ListaECFItemSubRecargo = new List<ECF_32.ECFItemSubRecargo>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"TipoSubRecargo[{ind}][{indice}]"))
                    {
                        if (Data[$"TipoSubRecargo[{ind}][{indice}]"] != null)
                        {
                            ...
                            ECF_32.ECFItemSubRecargo data = new ECF_32.ECFItemSubRecargo()
                            {
                                TipoSubRecargo = ObtenerTipoGeneral<ECF_32.TipoDescuentoRecargoType>($"TipoSubRecargo[{ind}][{indice}]"),
            ...
            public static ECF_32.ECFItemImpuestoAdicional[] ObtenerTablaImpuestoAdicional(Dictionary<string, string> Data, int ind)
            {
                List<ECF_32.ECFItemImpuestoAdicional> ListaImpuestoAdicional = new List<ECF_32.ECFItemImpuestoAdicional>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"TipoImpuesto[{ind}][{indice}]"))
                    {
                        if (Data[$"TipoImpuesto[{ind}][{indice}]"] != null)
                        {
                            ...
                            ECF_32.ECFItemImpuestoAdicional data = new ECF_32.ECFItemImpuestoAdicional()
                            {
                                TipoImpuesto = ObtenerTipoGeneral<ECF_32.CodificacionTipoImpuestosType>(Data[$"TipoImpuesto[{ind}][{indice}]"]),
                            };
                            // Agregar el objeto a la lista
            ...
            public static ECF_32.ECFSubtotal[] ObtenerSubtotalesl(Dictionary<string, string> Data)
            {
                List<ECF_32.ECFSubtotal> ListaSubtotales = new List<ECF_32.ECFSubtotal>();
                int indice = 1;
                if (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"NumeroSubTotal"))
                    {
                        if (Data[$"NumeroSubTotal"] != null)
                        {
                            ...
                            ECF_32.ECFSubtotal data = new ECF_32.ECFSubtotal()
                            {
            ...
            public static ECF_32.ECFDescuentoORecargo[] ObtenerDescuentosORecargos(Dictionary<string, string> Data)
            {
                List<ECF_32.ECFDescuentoORecargo> ListaDescuentosORecargos = new List<ECF_32.ECFDescuentoORecargo>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"NumeroLineaDoR[{indice}]"))
                    {
                        if (Data[$"NumeroLineaDoR[{indice}]"] != null)
                        {
                            ...
                            ECF_32.ECFDescuentoORecargo data = new ECF_32.ECFDescuentoORecargo()
                            {
                                NumeroLinea = Data[$"NumeroLineaDoR[{indice}]"],
                                TipoAjuste = ObtenerTipoGeneral<ECF_32.TipoAjusteType>($"TipoAjuste[{indice}]"),
                                IndicadorNorma1007 = ObtenerTipoGeneral<ECF_32.IndicadorNorma1007Type>(Data[$"IndicadorNorma1007[{indice}]"]),
                                ...
                                TipoValor = ObtenerTipoGeneral<ECF_32.TipoDescuentoRecargoType>($"TipoValor[{indice}]"),
                                ...
                                IndicadorFacturacionDescuentooRecargo = ObtenerTipoGeneral<ECF_32.IndicadorFacturacionDRType>(Data[$"IndicadorFacturacionDescuentooRecargo[{indice}]"]),
            ...
            public static ECF_32.ECFPagina[] ObtenerECFPagina(Dictionary<string, string> Data)
            {
                List<ECF_32.ECFPagina> ListaECFPagina = new List<ECF_32.ECFPagina>();
                int indice = 1;
                while (Data != null)
                {
                    ...
                    if (Data.ContainsKey($"PaginaNo[{indice}]"))
                    {
                        if (Data[$"PaginaNo[{indice}]"] != null)
                        {
                            ...
                            ECF_32.ECFPagina data = new ECF_32.ECFPagina()
                            {
                                ...
                                SubtotalImpuestoAdicional = new ECF_32.ECFPaginaSubtotalImpuestoAdicional()
                                {
        ...
        public static void Generar_XML_ECF32(Dictionary<string, string> Data)
        {
            ECF_32.ECF eCF_32 = new ECF_32.ECF();
            eCF_32.Encabezado = new ECF_32.ECFEncabezado()
            {
                Version = Metodos_General.TryParseDecimal(Data, "Version"),
                IdDoc = new ECF_32.ECFEncabezadoIdDoc()
                {
                    TipoeCF = ECF_32.TipoeCFType.Item32,
                    eNCF = Data["ENCF"],
                    IndicadorEnvioDiferidoSpecified = (Data["IndicadorEnvioDiferido"] == "1" || Data["IndicadorEnvioDiferido"] == "0"),
                    IndicadorEnvioDiferido = ECF_32.IndicadorEnvioDiferidoType.Item1,
                    IndicadorMontoGravadoSpecified = (Data["IndicadorMontoGravado"] == "1" || Data["IndicadorMontoGravado"] == "0"),
                    IndicadorMontoGravado = (Data["IndicadorMontoGravado"] == "1") ? ECF_32.IndicadorMontoGravadoType.Item1 : ECF_32.IndicadorMontoGravadoType.Item0,
                    TipoIngresos = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.TipoIngresosValidationType>(Data["TipoIngresos"]),
                    TipoPago = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.TipoPagoType>(Data["TipoPago"]),
                    FechaLimitePago = Data["FechaLimitePago"],
                    TerminoPago = Data["TerminoPago"],
                    TablaFormasPago = ObtenerValorECF_32.ObtenerTablaFormasPago(Data),
                    TipoCuentaPago = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.TipoCuentaPagoType>(Data["TipoCuentaPago"]),
                ...
                Emisor = new ECF_32.ECFEncabezadoEmisor()
                {
                    ...
                    Municipio = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.ProvinciaMunicipioType>(Data["Municipio"]),
                    ProvinciaSpecified = Data.ContainsKey("Provincia") && Data["Provincia"] != null,
                    Provincia = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.ProvinciaMunicipioType>(Data["Provincia"]),
                    TablaTelefonoEmisor = ObtenerValorECF_32.ObtenerTablaTelefonoEmisor(Data),
                ...
                Comprador = new ECF_32.ECFEncabezadoComprador()
                {
                    ...
                    MunicipioComprador = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.ProvinciaMunicipioType>(Data["MunicipioComprador"]),
                    ProvinciaCompradorSpecified = Data.ContainsKey("ProvinciaComprador") && Data["ProvinciaComprador"] != null,
                    ProvinciaComprador = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.ProvinciaMunicipioType>(Data["ProvinciaComprador"]),
                ...
                InformacionesAdicionales = new ECF_32.ECFEncabezadoInformacionesAdicionales
                {
                    ...
                    UnidadPesoBruto = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.UnidadMedidaType>(Data["UnidadPesoBruto"]),
                    UnidadPesoBrutoSpecified = Metodos_General.EsNumero(Data["UnidadPesoBruto"]),
                    UnidadPesoNeto = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.UnidadMedidaType>(Data["UnidadPesoNeto"]),
                    ...
                    UnidadBulto = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.UnidadMedidaType>(Data["UnidadBulto"]),
                    ...
                    UnidadVolumen = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.UnidadMedidaType>(Data["UnidadVolumen"]),
                    UnidadVolumenSpecified = Metodos_General.EsNumero(Data["UnidadVolumen"]),
                },
                Transporte = new ECF_32.ECFEncabezadoTransporte()
                {
                ...
                Totales = new ECF_32.ECFEncabezadoTotales()
                {
                    ...
                    ImpuestosAdicionales = ObtenerValorECF_32.ObtenerImpuestosAdicionales(Data),
                ...
                OtraMoneda = new ECF_32.ECFEncabezadoOtraMoneda()
                {
                    TipoMoneda = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.TipoMonedaType>(Data["TipoMoneda"]),
                    ...
                    ImpuestosAdicionalesOtraMoneda = ObtenerValorECF_32.ObtenerImpuestosAdicionalesOtraMoneda(Data),
            ...
            eCF_32.DetallesItems = ObtenerValorECF_32.ObtenerDetalleItem(Data);
            eCF_32.Subtotales = ObtenerValorECF_32.ObtenerSubtotalesl(Data);
            eCF_32.DescuentosORecargos = ObtenerValorECF_32.ObtenerDescuentosORecargos(Data);
            eCF_32.Paginacion = ObtenerValorECF_32.ObtenerECFPagina(Data);
            eCF_32.InformacionReferencia = new ECF_32.ECFInformacionReferencia
            {
                NCFModificado = Data["NCFModificado"],
                RNCOtroContribuyente = Data["RNCOtroContribuyente"],
                FechaNCFModificado = Data["FechaNCFModificado"],
                CodigoModificacion = ObtenerValorECF_32.ObtenerTipoGeneral<ECF_32.CodigoModificacionType>(Data["CodigoModificacion"]),
                CodigoModificacionSpecified = Metodos_General.EsNumero(Data["CodigoModificacion"]),
            };

            XmlSerializer serializer = new XmlSerializer(typeof(ECF_32.ECF));
            using (StringWriter writer = new StringWriter())
            {
                serializer.Serialize(writer, eCF_32);
                string xmlOutput = writer.ToString();
                XmlDocument xmlDocument = new XmlDocument();
                xmlDocument.LoadXml(xmlOutput);
                Metodos_General.XmlCorrector.FindValuesNotInXml(Data, xmlDocument);
                string a = Metodos_General.XmlCorrector.CorrectXml(xmlOutput, "E:\\Proyectos\\M_I_FE\\M_I_FE\\XSD\\e-CF 32 v.1.0.xsd");
                Console.WriteLine(a);

                Metodos_General.SaveContentToFile(a, "32");
            }
        }
    }
}
