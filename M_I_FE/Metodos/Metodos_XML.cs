...
namespace M_I_FE.Metodos
{
    public static class Metodos_XML
    {
        public static void GenerarXML()
        {
            ...
            // Medir el tiempo del segundo proceso
            var stopwatch2 = Stopwatch.StartNew();
            List<Dictionary<string, string>> listA = DatabaseHelper.GetComprobante();
            ...
            Console.WriteLine($"Tiempo del segundo proceso: {stopwatch2.ElapsedMilliseconds} ms");
        }
    }
}
